...
namespace HyperCasual.Runner
{
    ...
    public class TerrainGenerator : MonoBehaviour
    {
        ...
        public static void CreateTerrain2(TerrainDimensions terrainDimensions)
        {
            float width = terrainDimensions.Width;
            float length = terrainDimensions.Length;
            float startBuffer = terrainDimensions.StartBuffer;
            ...
            float offsetScaleYFactor = 2;
            float roadLengthFactor = 50f;
            GameObject terrainRoadPrefab = Resources.Load<GameObject>("RoadPrefab");
           // Debug.Log("lenght" + length);
            int numberOfRoadInstance = (int)(length * offsetScaleYFactor / roadLengthFactor);
